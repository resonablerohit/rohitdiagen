#
# Module manifest for module 'rohitazmap'
#

@{

# Script module or binary module file associated with this manifest.
RootModule = 'rohitazmap.psm1'
...
FunctionsToExport = @('Export-RohitAzMap')
...
PrivateData = @{
	...
	LicenseUri = 'https://github.com/resonablerohit/rohitazmap/blob/master/LICENSE'
        # A URL to the main website for this project.
	ProjectUri = 'https://github.com/resonablerohit/rohitazmap'
