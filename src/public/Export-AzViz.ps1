...
Export-rohitazmap -ResourceGroup demo-2 -Theme light -OutputFormat png -Show

.EXAMPLE
Visualizing a single resource group with more sub-categories

Export-rohitazmap -ResourceGroup demo-2 -Theme light -OutputFormat png -Show -CategoryDepth 2

.EXAMPLE
Visualizing multiple resource groups

Export-rohitazmap -ResourceGroup demo-2, demo-3 -LabelVerbosity 1 -CategoryDepth 1 -Theme light -Show -OutputFormat png

.EXAMPLE
Add more information in resource label like: Name, type, Provider etc using the '-LabelVerbosity' parameter

Export-rohitazmap -ResourceGroup demo-2 -Theme light -OutputFormat png -Show -LabelVerbosity 2

.EXAMPLE
Exclude Azure resources/providers from the visualization by passing them as an argument to the '-ExcludeTypes' parameter

Export-rohitazmap -ResourceGroup prateek -Show -ExcludeTypes "*workspace*", "Microsoft.Storage*" -Theme Neon
.NOTES
