Function Get-ASCIIArt {
    ...
    $ModuleVersion = (Import-PowerShellDataFile (Join-Path $ProjectRoot "rohitazmap.psd1")).ModuleVersion  

    $ASCIIArt = @"

    $b$b$b$b$b$tr $b$b$b$b$b$b$b$tr$b$b$tr   $b$b$tr$b$b$tr$b$b$b$b$b$b$b$tr   
   $b$b$tl$mid$mid$b$b$tr$bl$mid$mid$b$b$b$tl$br$b$b$full   $b$b$full$b$b$full$bl$mid$mid$b$b$b$tl$br   Author    : Rohit Raj (Twitter @singhprateik)
   ...
   $b$b$tl$mid$mid$b$b$full $b$b$b$tl$br  $bl$b$b$tr $b$b$tl$br$b$b$full $b$b$b$tl$br     Github    : https://github.com/PrateekKumarSingh/rohitazmap
